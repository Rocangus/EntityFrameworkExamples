...
namespace EntityFrameworkExamples.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,EnrollmentId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,EnrollmentId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
